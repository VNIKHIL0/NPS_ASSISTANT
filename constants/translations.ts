export type Language = "en" | "hi" | "ta" | "te" | "bn" | "mr" | "gu" | "kn" | "ml" | "pa" | "or" | "as" | "ur" | "sa" | "mai" | "sat" | "ks" | "ne" | "sd" | "kok" | "doi" | "mni" | "brx";

export const languageNames: Record<Language, string> = {
    en: "English", hi: "हिन्दी", ta: "தமிழ்", te: "తెలుగు", bn: "বাংলা",
    mr: "मराठी", gu: "ગુજરાતી", kn: "ಕನ್ನಡ", ml: "മലയാളം", pa: "ਪੰਜਾਬੀ",
    or: "ଓଡ଼ିଆ", as: "অসমীয়া", ur: "اردو", sa: "संस्कृतम्", mai: "मैथिली",
    sat: "ᱥᱟᱱᱛᱟᱲᱤ", ks: "کٲشُر", ne: "नेपाली", sd: "سنڌي", kok: "कोंकणी",
    doi: "डोगरी", mni: "মৈতৈলোন্", brx: "बड़ो",
};

// Full language names in English for AI system prompt
export const languageFullNames: Record<Language, string> = {
    en: "English", hi: "Hindi", ta: "Tamil", te: "Telugu", bn: "Bengali",
    mr: "Marathi", gu: "Gujarati", kn: "Kannada", ml: "Malayalam", pa: "Punjabi",
    or: "Odia", as: "Assamese", ur: "Urdu", sa: "Sanskrit", mai: "Maithili",
    sat: "Santali", ks: "Kashmiri", ne: "Nepali", sd: "Sindhi", kok: "Konkani",
...
const en = {
    nav: { brand: "NPS Assistant", home: "Home", ai: "AI Assistant", calc: "Calculator", plan: "Planner", learn: "Learn", login: "Login", getStarted: "Get Started" },
    hero: {
        tag: "Powered by Generative AI", title: "Secure Your Future with NPS Assistant",
        subtitle: "Get instant answers, personalized pension planning, and financial education in your language.",
        ctaChat: "Talk to AI Agent", ctaCalc: "Calculate Pension",
        featuresTitle: "Everything you need to know", featuresSubtitle: "Comprehensive tools to manage your retirement planning.",
        f1title: "Multilingual AI Chat", f1desc: "Ask questions in any Indian language. Our AI understands and responds in all 22 official languages.",
        f2title: "Pension Calculator", f2desc: "Visualize your future wealth with our interactive calculator.",
        f3title: "Financial Literacy", f3desc: "Master the National Pension System with easy-to-understand guides.",
        ctaBannerTitle: "Ready to plan your retirement?", ctaBannerDesc: "Start a conversation with our AI assistant and get personalized guidance in seconds.",
        ctaBannerBtn: "Start Chatting",
    },
    stats: { subscribers: "Subscribers", aum: "AUM", returns: "Avg Returns", govtBacked: "Govt Backed" },
    chat: {
        header: "NPS AI Assistant", subheader: "Powered by Gemini AI • Government of India",
        emptyTitle: "NPS AI Assistant", emptyDesc: "Ask me anything about the National Pension System — tax benefits, withdrawal rules, account management, and more.",
        q1: "💰 Tax Benefits", q2: "📋 Open Account", q3: "🏦 Withdrawal Rules", q4: "📊 Tier I vs Tier II",
    ...
    calc: {
        badge: "Pension Calculator", title: "NPS Pension Calculator",
        ...
        invested: "Total Invested", wealth: "Wealth Gained", corpus: "Total Corpus", pension: "Monthly Pension (est)",
        inputTitle: "Your Inputs", inputDesc: "Customize your investment plan",
        age: "Current Age", retAge: "Retirement Age", monthly: "Monthly Contribution", expReturn: "Expected Return",
        duration: "Duration", taxSaved: "Tax saved (80CCD)", taxValue: "Up to ₹2L/year", years: "years",
        chartTitle: "Growth Projection", loading: "Loading Chart...",
    },
    learn: {
        badge: "Financial Education", title: "Financial Wisdom Hub",
        subtitle: "Master your retirement planning with our curated guides and resources about the National Pension System.",
        a1title: "Understanding NPS Tiers", a1cat: "Basics",
        ...
        a2title: "Tax Benefits Explained", a2cat: "Tax Savings",
        ...
        ctaTitle: "Confused? Ask our AI Expert.", ctaDesc: "Don't want to read through long manuals? Just chat with our AI assistant in your preferred language.",
...
const hi: TranslationSet = {
    nav: { brand: "एनपीएस सहायक", home: "होम", ai: "एआई सहायक", calc: "कैलकुलेटर", plan: "प्लानर", learn: "सीखें", login: "लॉगिन", getStarted: "शुरू करें" },
    hero: {
        tag: "जेनेरेटिव एआई द्वारा संचालित", title: "एनपीएस सहायक के साथ अपना भविष्य सुरक्षित करें",
        subtitle: "अपनी भाषा में त्वरित उत्तर, व्यक्तिगत पेंशन योजना और वित्तीय शिक्षा प्राप्त करें।",
        ctaChat: "एआई एजेंट से बात करें", ctaCalc: "पेंशन की गणना करें",
        featuresTitle: "वह सब कुछ जो आपको जानना आवश्यक है", featuresSubtitle: "आपकी सेवानिवृत्ति योजना के लिए व्यापक उपकरण।",
        f1title: "बहुभाषी एआई चैट", f1desc: "किसी भी भारतीय भाषा में प्रश्न पूछें। हमारा एआई सभी 22 आधिकारिक भाषाओं में जवाब देता है।",
        f2title: "पेंशन कैलकुलेटर", f2desc: "हमारे इंटरैक्टिव कैलकुलेटर से अपनी भविष्य की संपत्ति देखें।",
        f3title: "वित्तीय साक्षरता", f3desc: "आसान गाइड के साथ राष्ट्रीय पेंशन प्रणाली में महारत हासिल करें।",
        ctaBannerTitle: "अपनी सेवानिवृत्ति की योजना बनाने के लिए तैयार हैं?", ctaBannerDesc: "हमारे एआई सहायक से बात करें और सेकंडों में मार्गदर्शन पाएं।",
        ctaBannerBtn: "चैट शुरू करें",
    },
    stats: { subscribers: "ग्राहक", aum: "एयूएम", returns: "औसत रिटर्न", govtBacked: "सरकार समर्थित" },
    chat: {
        header: "एनपीएस एआई सहायक", subheader: "जेमिनी एआई द्वारा संचालित • भारत सरकार",
        emptyTitle: "एनपीएस एआई सहायक", emptyDesc: "राष्ट्रीय पेंशन प्रणाली के बारे में कुछ भी पूछें — कर लाभ, निकासी नियम, खाता प्रबंधन।",
        q1: "💰 कर लाभ", q2: "📋 खाता खोलें", q3: "🏦 निकासी नियम", q4: "📊 टियर I बनाम II",
    ...
    calc: {
        badge: "पेंशन कैलकुलेटर", title: "एनपीएस पेंशन कैलकुलेटर",
        subtitle: "चक्रवृद्धि की शक्ति देखें। स्लाइडर्स को समायोजित करें।",
        invested: "कुल निवेश", wealth: "संपत्ति लाभ", corpus: "कुल कोष", pension: "मासिक पेंशन (अनु.)",
        inputTitle: "आपके इनपुट", inputDesc: "अपनी निवेश योजना अनुकूलित करें",
        age: "वर्तमान आयु", retAge: "सेवानिवृत्ति आयु", monthly: "मासिक योगदान", expReturn: "अपेक्षित रिटर्न",
        duration: "अवधि", taxSaved: "कर बचत (80CCD)", taxValue: "₹2L/वर्ष तक", years: "वर्ष",
        chartTitle: "वृद्धि अनुमान", loading: "चार्ट लोड हो रहा है...",
    },
    learn: {
        badge: "वित्तीय शिक्षा", title: "वित्तीय ज्ञान केंद्र",
        subtitle: "राष्ट्रीय पेंशन प्रणाली के बारे में हमारे गाइड से सेवानिवृत्ति योजना में महारत हासिल करें।",
        a1title: "एनपीएस टियर समझें", a1cat: "मूल बातें",
        a1desc: "टियर I सरकारी कर्मचारियों के लिए अनिवार्य है, जबकि टियर II एक स्वैच्छिक बचत खाता है।",
        a2title: "कर लाभ समझाए गए", a2cat: "कर बचत",
        a2desc: "धारा 80C के तहत ₹1.5 लाख और 80CCD(1B) के तहत अतिरिक्त ₹50,000 बचाएं।",
        a3title: "निकासी नियम", a3cat: "नियमन",
        a3desc: "60 वर्ष की आयु में अपने कोष का 60% तक कर-मुक्त निकाल सकते हैं।",
        a4title: "निवेश विकल्प", a4cat: "निवेश",
        a4desc: "ऑटो चॉइस या एक्टिव चॉइस के बीच चुनें — इक्विटी, कॉर्पोरेट बॉन्ड, सरकारी प्रतिभूतियां।",
        readMore: "पूरा लेख पढ़ें",
        ctaTitle: "भ्रमित हैं? हमारे एआई विशेषज्ञ से पूछें।", ctaDesc: "लंबे मैनुअल नहीं पढ़ना चाहते? बस हमारे एआई सहायक से चैट करें।",
...
function makeLang(nav: Partial<TranslationSet['nav']>, hero: Partial<TranslationSet['hero']>, stats: Partial<TranslationSet['stats']>,
    chat: Partial<TranslationSet['chat']>, calc: Partial<TranslationSet['calc']>, learn: Partial<TranslationSet['learn']>,
    planner?: Partial<TranslationSet['planner']>): TranslationSet {
    return {
        nav: { ...en.nav, ...nav }, hero: { ...en.hero, ...hero }, stats: { ...en.stats, ...stats },
        chat: { ...en.chat, ...chat }, calc: { ...en.calc, ...calc }, learn: { ...en.learn, ...learn },
        planner: { ...en.planner, ...planner },
    };
}

const ta = makeLang(
    { brand: "NPS உதவியாளர்", home: "முகப்பு", ai: "AI உதவியாளர்", calc: "கால்குலேட்டர்", plan: "திட்டமிடுபவர்", learn: "கற்றுக்கொள்", login: "உள்நுழைய", getStarted: "தொடங்கு" },
    { tag: "ஜெனரேட்டிவ் AI மூலம் இயக்கப்படுகிறது", title: "NPS உதவியாளருடன் உங்கள் எதிர்காலத்தைப் பாதுகாக்கவும்", subtitle: "உங்கள் மொழியில் உடனடி பதில்கள், தனிப்பயன் ஓய்வூதிய திட்டமிடல் மற்றும் நிதிக் கல்வி பெறுங்கள்.", ctaChat: "AI முகவருடன் பேசு", ctaCalc: "ஓய்வூதியம் கணக்கிடு", featuresTitle: "நீங்கள் தெரிந்துகொள்ள வேண்டிய அனைத்தும்", f1title: "பல மொழி AI அரட்டை", f2title: "ஓய்வூதிய கால்குலேட்டர்", f3title: "நிதி கல்வி", ctaBannerTitle: "உங்கள் ஓய்வுக் காலத்தை திட்டமிடத் தயாரா?", ctaBannerBtn: "அரட்டை தொடங்கு" },
    { subscribers: "சந்தாதாரர்கள்", aum: "AUM", returns: "சராசரி வருமானம்", govtBacked: "அரசு ஆதரவு" },
    { header: "NPS AI உதவியாளர்", emptyTitle: "NPS AI உதவியாளர்", emptyDesc: "தேசிய ஓய்வூதிய திட்டம் பற்றி எதையும் கேளுங்கள்.", q1: "💰 வரிச் சலுகைகள்", q2: "📋 கணக்கு திறக்க", q3: "🏦 திரும்பப்பெறும் விதிகள்", q4: "📊 டையர் I vs II", placeholder: "NPS, வரிச் சலுகைகள் பற்றி கேளுங்கள்...", liveAssistant: "நேரடி உதவியாளர்", listening: "நான் கேட்கிறேன்...", thinking: "சிந்திக்கிறேன்..." },
    { badge: "ஓய்வூதிய கால்குலேட்டர்", title: "NPS ஓய்வூதிய கால்குலேட்டர்", invested: "மொத்த முதலீடு", wealth: "செல்வ ஆதாயம்", corpus: "மொத்த நிதி", pension: "மாத ஓய்வூதியம்", inputTitle: "உங்கள் உள்ளீடுகள்", age: "தற்போதைய வயது", retAge: "ஓய்வு வயது", monthly: "மாதாந்திர பங்களிப்பு", expReturn: "எதிர்பார்க்கப்படும் வருமானம்", chartTitle: "வளர்ச்சி கணிப்பு", years: "ஆண்டுகள்" },
    { badge: "நிதிக் கல்வி", title: "நிதி ஞான மையம்", a1title: "NPS அடுக்குகளைப் புரிந்துகொள்", a2title: "வரிச் சலுகைகள் விளக்கம்", a3title: "திரும்பப்பெறும் விதிகள்", a4title: "முதலீட்டு விருப்பங்கள்", readMore: "முழு கட்டுரை படிக்க", ctaTitle: "குழப்பமா? எங்கள் AI நிபுணரிடம் கேளுங்கள்.", ctaBtn: "அரட்டை தொடங்கு" },
    {
...
const te = makeLang(
    { brand: "NPS సహాయకుడు", home: "హోమ్", ai: "AI సహాయకుడు", calc: "కాలిక్యులేటర్", learn: "నేర్చుకో", getStarted: "ప్రారంభించు" },
    { tag: "జెనరేటివ్ AI ద్వారా", title: "NPS సహాయకుడితో మీ భవిష్యత్తును భద్రం చేసుకోండి", subtitle: "మీ భాషలో తక్షణ సమాధానాలు, పెన్షన్ ప్రణాళిక మరియు ఆర్థిక విద్య పొందండి.", ctaChat: "AI ఏజెంట్‌తో మాట్లాడండి", ctaCalc: "పెన్షన్ లెక్కించండి", featuresTitle: "మీరు తెలుసుకోవలసినవన్నీ", ctaBannerTitle: "మీ పదవీ విరమణను ప్రణాళిక చేయడానికి సిద్ధంగా ఉన్నారా?", ctaBannerBtn: "చాట్ ప్రారంభించు" },
    { subscribers: "చందాదారులు", returns: "సగటు రాబడి", govtBacked: "ప్రభుత్వ మద్దతు" },
    { header: "NPS AI సహాయకుడు", emptyDesc: "జాతీయ పెన్షన్ వ్యవస్థ గురించి ఏదైనా అడగండి.", placeholder: "NPS, పన్ను ప్రయోజనాల గురించి అడగండి...", liveAssistant: "లైవ్ అసిస్టెంట్", listening: "నేను వింటున్నాను...", thinking: "ఆలోచిస్తున్నాను..." },
    { badge: "పెన్షన్ కాలిక్యులేటర్", title: "NPS పెన్షన్ కాలిక్యులేటర్", invested: "మొత్తం పెట్టుబడి", wealth: "సంపద లాభం", corpus: "మొత్తం కార్పస్", pension: "నెలవారీ పెన్షన్", inputTitle: "మీ ఇన్‌పుట్‌లు", age: "ప్రస్తుత వయసు", retAge: "రిటైర్మెంట్ వయసు", monthly: "నెలవారీ సహకారం", chartTitle: "వృద్ధి అంచనా", years: "సంవత్సరాలు" },
    { badge: "ఆర్థిక విద్య", title: "ఆర్థిక జ్ఞాన కేంద్రం", readMore: "పూర్తి వ్యాసం చదవండి", ctaTitle: "అయోమయంగా ఉందా? మా AI నిపుణుడిని అడగండి.", ctaBtn: "చాట్ ప్రారంభించు" },
    {
...
const bn = makeLang(
    { brand: "NPS সহায়ক", home: "হোম", ai: "AI সহায়ক", calc: "ক্যালকুলেটর", learn: "শিখুন", getStarted: "শুরু করুন" },
    { tag: "জেনারেটিভ AI দ্বারা চালিত", title: "NPS সহায়কের সাথে আপনার ভবিষ্যৎ সুরক্ষিত করুন", subtitle: "আপনার ভাষায় তাৎক্ষণিক উত্তর, পেনশন পরিকল্পনা এবং আর্থিক শিক্ষা পান।", ctaChat: "AI এজেন্টের সাথে কথা বলুন", ctaCalc: "পেনশন গণনা করুন", featuresTitle: "আপনার জানা দরকার সবকিছু", ctaBannerTitle: "অবসর পরিকল্পনা করতে প্রস্তুত?", ctaBannerBtn: "চ্যাট শুরু করুন" },
    { subscribers: "গ্রাহক", returns: "গড় রিটার্ন", govtBacked: "সরকার সমর্থিত" },
    { header: "NPS AI সহায়ক", emptyDesc: "জাতীয় পেনশন প্রকল্প সম্পর্কে যেকোনো কিছু জিজ্ঞাসা করুন।", placeholder: "NPS, কর সুবিধা সম্পর্কে জিজ্ঞাসা করুন...", liveAssistant: "লাইভ সহকারী", listening: "আমি শুনছি...", thinking: "ভাবছি..." },
    { badge: "পেনশন ক্যালকুলেটর", title: "NPS পেনশন ক্যালকুলেটর", invested: "মোট বিনিয়োগ", wealth: "সম্পদ লাভ", corpus: "মোট কর্পাস", pension: "মাসিক পেনশন", inputTitle: "আপনার ইনপুট", age: "বর্তমান বয়স", retAge: "অবসরের বয়স", monthly: "মাসিক অবদান", chartTitle: "প্রবৃদ্ধি অনুমান", years: "বছর" },
    { badge: "আর্থিক শিক্ষা", title: "আর্থিক জ্ঞান কেন্দ্র", readMore: "সম্পূর্ণ নিবন্ধ পড়ুন", ctaTitle: "বিভ্রান্ত? আমাদের AI বিশেষজ্ঞকে জিজ্ঞাসা করুন।", ctaBtn: "চ্যাট শুরু করুন" }
);

const mr = makeLang(
    { brand: "NPS सहाय्यक", home: "मुख्यपृष्ठ", ai: "AI सहाय्यक", calc: "कॅल्क्युलेटर", learn: "शिका", getStarted: "सुरू करा" },
    { title: "NPS सहाय्यकासह तुमचे भविष्य सुरक्षित करा", subtitle: "तुमच्या भाषेत त्वरित उत्तरे, पेन्शन नियोजन आणि आर्थिक शिक्षण मिळवा.", ctaChat: "AI एजंटशी बोला", ctaCalc: "पेन्शन मोजा", featuresTitle: "तुम्हाला जे माहित असणे आवश्यक आहे", ctaBannerTitle: "तुमच्या निवृत्तीचे नियोजन करण्यास तयार आहात?", ctaBannerBtn: "चॅट सुरू करा" },
    { subscribers: "ग्राहक", returns: "सरासरी परतावा", govtBacked: "सरकार समर्थित" },
    { header: "NPS AI सहाय्यक", emptyDesc: "राष्ट्रीय पेन्शन योजनेबद्दल काहीही विचारा.", placeholder: "NPS, कर लाभांबद्दल विचारा...", liveAssistant: "लाइव्ह सहाय्यक", listening: "मी ऐकत आहे...", thinking: "विचार करत आहे..." },
    { badge: "पेन्शन कॅल्क्युलेटर", title: "NPS पेन्शन कॅल्क्युलेटर", invested: "एकूण गुंतवणूक", wealth: "संपत्ती लाभ", corpus: "एकूण कॉर्पस", pension: "मासिक पेन्शन", inputTitle: "तुमचे इनपुट्स", age: "सध्याचे वय", retAge: "निवृत्ती वय", monthly: "मासिक योगदान", chartTitle: "वृद्धी अंदाज", years: "वर्षे" },
    { badge: "आर्थिक शिक्षण", title: "आर्थिक ज्ञान केंद्र", readMore: "पूर्ण लेख वाचा", ctaTitle: "गोंधळात आहात? आमच्या AI तज्ञांना विचारा.", ctaBtn: "चॅट सुरू करा" },
    {
...
const gu = makeLang(
    { brand: "NPS સહાયક", home: "હોમ", ai: "AI સહાયક", calc: "કેલ્ક્યુલેટર", learn: "શીખો", getStarted: "શરૂ કરો" },
    { title: "NPS સહાયક સાથે તમારું ભવિષ્ય સુરક્ષિત કરો", ctaChat: "AI એજન્ટ સાથે વાત કરો", ctaCalc: "પેન્શન ગણો", ctaBannerTitle: "નિવૃત્તિનું આયોજન કરવા તૈયાર છો?", ctaBannerBtn: "ચેટ શરૂ કરો" },
    { subscribers: "ગ્રાહકો", returns: "સરેરાશ વળતર", govtBacked: "સરકારી સમર્થન" },
    { header: "NPS AI સહાયક", thinking: "વિચારી રહ્યું છે...", placeholder: "NPS, ટેક્સ લાભો વિશે પૂછો..." },
    { badge: "પેન્શન કેલ્ક્યુલેટર", title: "NPS પેન્શન કેલ્ક્યુલેટર", invested: "કુલ રોકાણ", corpus: "કુલ ભંડોળ", pension: "માસિક પેન્શન", age: "વર્તમાન ઉંમર", chartTitle: "વૃદ્ધિ અનુમાન", years: "વર્ષો" },
    { badge: "નાણાકીય શિક્ષણ", title: "નાણાકીય જ્ઞાન કેન્દ્ર", readMore: "પૂરો લેખ વાંચો", ctaTitle: "મુંઝવણ છે? અમારા AI નિષ્ણાતને પૂછો.", ctaBtn: "ચેટ શરૂ કરો" },
    {
...
const kn = makeLang(
    { brand: "NPS ಸಹಾಯಕ", home: "ಮುಖಪುಟ", ai: "AI ಸಹಾಯಕ", calc: "ಕ್ಯಾಲ್ಕುಲೇಟರ್", learn: "ಕಲಿಯಿರಿ", getStarted: "ಪ್ರಾರಂಭಿಸಿ" },
    { title: "NPS ಸಹಾಯಕದೊಂದಿಗೆ ನಿಮ್ಮ ಭವಿಷ್ಯವನ್ನು ಸುರಕ್ಷಿತಗೊಳಿಸಿ", ctaChat: "AI ಏಜೆಂಟ್‌ನೊಂದಿಗೆ ಮಾತನಾಡಿ", ctaCalc: "ಪಿಂಚಣಿ ಲೆಕ್ಕಹಾಕಿ", ctaBannerTitle: "ನಿಮ್ಮ ನಿವೃತ್ತಿಯನ್ನು ಯೋಜಿಸಲು ಸಿದ್ಧರಾ?", ctaBannerBtn: "ಚಾಟ್ ಪ್ರಾರಂಭಿಸಿ" },
    { subscribers: "ಚಂದಾದಾರರು", returns: "ಸರಾಸರಿ ಆದಾಯ", govtBacked: "ಸರ್ಕಾರ ಬೆಂಬಲಿತ" },
    { header: "NPS AI ಸಹಾಯಕ", thinking: "ಯೋಚಿಸುತ್ತಿದೆ...", placeholder: "NPS, ತೆರಿಗೆ ಪ್ರಯೋಜನಗಳ ಬಗ್ಗೆ ಕೇಳಿ..." },
    { badge: "ಪಿಂಚಣಿ ಕ್ಯಾಲ್ಕುಲೇಟರ್", title: "NPS ಪಿಂಚಣಿ ಕ್ಯಾಲ್ಕುಲೇಟರ್", invested: "ಒಟ್ಟು ಹೂಡಿಕೆ", corpus: "ಒಟ್ಟು ಕಾರ್ಪಸ್", pension: "ಮಾಸಿಕ ಪಿಂಚಣಿ", age: "ಪ್ರಸ್ತುತ ವಯಸ್ಸು", chartTitle: "ಬೆಳವಣಿಗೆ ಅಂದಾಜು", years: "ವರ್ಷಗಳು" },
    { badge: "ಹಣಕಾಸು ಶಿಕ್ಷಣ", title: "ಹಣಕಾಸು ಜ್ಞಾನ ಕೇಂದ್ರ", readMore: "ಪೂರ್ಣ ಲೇಖನ ಓದಿ", ctaTitle: "ಗೊಂದಲವಿದೆಯೇ? ನಮ್ಮ AI ತಜ್ಞರನ್ನು ಕೇಳಿ.", ctaBtn: "ಚಾಟ್ ಪ್ರಾರಂಭಿಸಿ" },
    {
...
const ml = makeLang(
    { brand: "NPS അസിസ്റ്റന്റ്", home: "ഹോം", ai: "AI അസിസ്റ്റന്റ്", calc: "കാൽക്കുലേറ്റർ", learn: "പഠിക്കുക", getStarted: "തുടങ്ങുക" },
    { title: "NPS അസിസ്റ്റന്റുമായി നിങ്ങളുടെ ഭാവി സുരക്ഷിതമാക്കുക", ctaChat: "AI ഏജന്റിനോട് സംസാരിക്കുക", ctaCalc: "പെൻഷൻ കണക്കാക്കുക", ctaBannerTitle: "നിങ്ങളുടെ വിരമിക്കൽ ആസൂത്രണം ചെയ്യാൻ തയ്യാറാണോ?", ctaBannerBtn: "ചാറ്റ് ആരംഭിക്കുക" },
    { subscribers: "ഗ്രാഹകർ", returns: "ശരാശരി വരുമാനം", govtBacked: "സർക്കാർ പിന്തുണ" },
    { header: "NPS AI അസിസ്റ്റന്റ്", thinking: "ചിന്തിക്കുന്നു...", placeholder: "NPS, നികുതി ആനുകൂല്യങ്ങളെ കുറിച്ച് ചോദിക്കുക..." },
    { badge: "പെൻഷൻ കാൽക്കുലേറ്റർ", title: "NPS പെൻഷൻ കാൽക്കുലേറ്റർ", invested: "ആകെ നിക്ഷേപം", corpus: "ആകെ കോർപ്പസ്", pension: "പ്രതിമാസ പെൻഷൻ", age: "നിലവിലെ പ്രായം", chartTitle: "വളർച്ചാ പ്രവചനം", years: "വർഷം" },
    { badge: "സാമ്പത്തിക വിദ്യാഭ്യാസം", title: "സാമ്പത്തിക ജ്ഞാന കേന്ദ്രം", readMore: "പൂർണ്ണ ലേഖനം വായിക്കുക", ctaTitle: "ആശയക്കുഴപ്പമുണ്ടോ? ഞങ്ങളുടെ AI വിദഗ്ധനോട് ചോദിക്കുക.", ctaBtn: "ചാറ്റ് ആരംഭിക്കുക" },
    {
...
const pa = makeLang(
    { brand: "NPS ਸਹਾਇਕ", home: "ਹੋਮ", ai: "AI ਸਹਾਇਕ", calc: "ਕੈਲਕੁਲੇਟਰ", learn: "ਸਿੱਖੋ", getStarted: "ਸ਼ੁਰੂ ਕਰੋ" },
    { title: "NPS ਸਹਾਇਕ ਨਾਲ ਆਪਣਾ ਭਵਿੱਖ ਸੁਰੱਖਿਅਤ ਕਰੋ", ctaChat: "AI ਏਜੰਟ ਨਾਲ ਗੱਲ ਕਰੋ", ctaCalc: "ਪੈਨਸ਼ਨ ਗਣਨਾ", ctaBannerTitle: "ਆਪਣੀ ਰਿਟਾਇਰਮੈਂਟ ਯੋਜਨਾ ਬਣਾਉਣ ਲਈ ਤਿਆਰ ਹੋ?", ctaBannerBtn: "ਚੈਟ ਸ਼ੁਰੂ ਕਰੋ" },
    { subscribers: "ਗਾਹਕ", returns: "ਔਸਤ ਵਾਪਸੀ", govtBacked: "ਸਰਕਾਰ ਸਮਰਥਿਤ" },
    { header: "NPS AI ਸਹਾਇਕ", thinking: "ਸੋਚ ਰਿਹਾ ਹੈ...", placeholder: "NPS, ਟੈਕਸ ਲਾਭਾਂ ਬਾਰੇ ਪੁੱਛੋ..." },
    { badge: "ਪੈਨਸ਼ਨ ਕੈਲਕੁਲੇਟਰ", title: "NPS ਪੈਨਸ਼ਨ ਕੈਲਕੁਲੇਟਰ", invested: "ਕੁੱਲ ਨਿਵੇਸ਼", corpus: "ਕੁੱਲ ਕਾਰਪਸ", pension: "ਮਹੀਨਾਵਾਰ ਪੈਨਸ਼ਨ", age: "ਮੌਜੂਦਾ ਉਮਰ", chartTitle: "ਵਾਧਾ ਅਨੁਮਾਨ", years: "ਸਾਲ" },
    { badge: "ਵਿੱਤੀ ਸਿੱਖਿਆ", title: "ਵਿੱਤੀ ਗਿਆਨ ਕੇਂਦਰ", readMore: "ਪੂਰਾ ਲੇਖ ਪੜ੍ਹੋ", ctaTitle: "ਉਲਝਣ ਵਿੱਚ ਹੋ? ਸਾਡੇ AI ਮਾਹਰ ਨੂੰ ਪੁੱਛੋ.", ctaBtn: "ਚੈਟ ਸ਼ੁਰੂ ਕਰੋ" },
    {
...
const or = makeLang(
    { brand: "NPS ସହାୟକ", home: "ହୋଉମ୍", ai: "AI ସହାୟକ", calc: "କାଲକୁଲେଟର", learn: "ଶିକ୍ଷା", getStarted: "ଆରମ୍ଭ କରନ୍ତୁ" },
    { title: "NPS ସହାୟକ ସହିତ ଆପଣଙ୍କ ଭବିଷ୍ୟତ ସୁରକ୍ଷିତ କରନ୍ତୁ", ctaChat: "AI ଏଜେଣ୍ଟ ସହିତ କଥା ହୁଅନ୍ତୁ", ctaCalc: "ପେନସନ ଗଣନା କରନ୍ତୁ" },
    { subscribers: "ଗ୍ରାହକ", returns: "ହାରାହାରି ରିଟର୍ଣ୍ଣ" },
    { header: "NPS AI ସହାୟକ", placeholder: "NPS ବିଷୟରେ ପଚାରନ୍ତୁ..." },
    { badge: "ପେନସନ କାଲକୁଲେଟର", title: "NPS ପେନସନ କାଲକୁଲେଟର", invested: "ମୋଟ ନିବେଶ", corpus: "ମୋଟ ପାଣ୍ଠି", pension: "ମାସିକ ପେନସନ", years: "ବର୍ଷ" },
    { badge: "ଆର୍ଥିକ ଶିକ୍ଷା", title: "ଆର୍ଥିକ ଜ୍ଞାନ କେନ୍ଦ୍ର", readMore: "ପୂରା ପଢନ୍ତୁ" },
    {
...
const as = makeLang(
    { brand: "NPS সহায়ক", home: "হোম", ai: "AI সহায়ক", calc: "কেলকুলেটৰ", learn: "শিকক", getStarted: "আৰম্ভ কৰক" },
    { title: "NPS সহায়কৰ সৈতে আপোনাৰ ভৱিষ্যত সুৰক্ষিত কৰক", ctaChat: "AI এজেন্টৰ সৈতে কথা পাতক", ctaCalc: "পেনচন গণনা কৰক" },
    { subscribers: "গ্রাহক", returns: "গড় ৰিটাৰ্ণ" },
    { header: "NPS AI সহায়ক", placeholder: "NPS ৰ বিষয়ে সোধক..." },
    { badge: "পেনচন কেলকুলেটৰ", title: "NPS পেনচন কেলকুলেটৰ", invested: "মুঠ বিনিয়োগ", corpus: "মুঠ পুজি", pension: "মাহিলি পেনচন", years: "বছৰ" },
    { badge: "বিত্তীয় শিক্ষা", title: "বিত্তীয় জ্ঞান কেন্দ্ৰ", readMore: "সম্পূৰ্ণকৈ পঢ়ক" },
    {
...
const sa = makeLang(
    { brand: "NPS सहायकः", home: "मुख्यपुटम्", ai: "AI सहायकः", calc: "गणकयन्त्रम्", learn: "शिक्षस्व", getStarted: "आरभस्व" },
    { title: "NPS सहायकेन सह स्वभविष्यं रक्षितुं शक्नोति", ctaChat: "AI सहायकेन सह वदतु", ctaCalc: "निवृत्तिवेतनं गणयतु" },
    { subscribers: "ग्राहकाः", returns: "औसत लाभः" },
    { header: "NPS AI सहायकः", placeholder: "NPS विषयकम् पृच्छतु..." },
    { badge: "गणकयन्त्रम्", title: "NPS निवृत्तिवेतन गणकयन्त्रम्", invested: "कुल निवेशः", corpus: "कुल राशिः", pension: "मासिक निवृत्तिवेतनम्", years: "वर्षाणि" },
    { badge: "शिक्षा", title: "ज्ञान केन्द्रम्", readMore: "अधिकं पठतु" },
    {
...
const ur = makeLang(
    { brand: "NPS معاون", home: "ہوم", ai: "AI معاون", calc: "کیلکولیٹر", learn: "سیکھیں", getStarted: "شروع کریں" },
    { title: "NPS معاون کے ساتھ اپنا مستقبل محفوظ بنائیں", ctaChat: "AI ایجنٹ سے بات کریں", ctaCalc: "پنشن کا حساب لگائیں" },
    { subscribers: "صارفین", returns: "ہمارا اوسط ریٹرن", govtBacked: "حکومت کی مدد" },
    { header: "NPS AI معاون", placeholder: "NPS کے بارے میں پوچھیں..." },
    { badge: "پنشن کیلکولیٹر", title: "NPS پنشن کیلکولیٹر", invested: "کل سرمایہ کاری", corpus: "کل فنڈ", pension: "ماہانہ پنشن", years: "سال" },
    { badge: "مالیاتی تعلیم", title: "علمی مرکز", readMore: "مزید پڑھیں" },
    {
        title: "AI پنشن پلانر",
...
const mai = makeLang(
    ...
    {},
    { header: "NPS AI सहायक", thinking: "सोचि रहल अछि..." },
...
const satT = makeLang(
    ...
    {},
    {},
    { title: "AI ᱯᱮᱱᱥᱚᱱ ᱯᱞᱟᱱᱟᱨ", subtitle: "AI ᱥᱟᱶᱛᱮ ᱟᱢᱟᱜ ᱯᱮᱱᱥᱚᱱ ᱯᱞᱟᱱ ᱵᱮᱱᱟᱣ ᱢᱮ" }
);
const ksT = makeLang(
    { brand: "NPS معاون" },
    ...
    {},
    {},
    { title: "AI پینشن پلانر", subtitle: "AI سٟتؠ پنین ریٹائرمنٹ پلان بنایِو" }
);
const neT = makeLang(
    { brand: "NPS सहायक", home: "गृहपृष्ठ", getStarted: "सुरु गर्नुहोस्" },
    { title: "NPS सहायक संग तपाईंको भविष्य सुरक्षित गर्नुहोस्", ctaChat: "AI एजेन्टसँग कुरा गर्नुहोस्", ctaBannerBtn: "च्याट सुरु गर्नुहोस्" },
    {},
    { header: "NPS AI सहायक", thinking: "सोचिरहेको छ..." },
    { title: "NPS पेन्सन क्याल्कुलेटर" },
    { title: "वित्तीय ज्ञान केन्द्र", ctaBtn: "च्याट सुरु गर्नुहोस्" },
    {
...
const sdT = makeLang(
    ...
    {},
    {},
    { title: "AI پنشن پلانر", subtitle: "AI سان پنهنجو ریٽائرمنٽ پلان ٺاهيو" }
);
const kokT = makeLang(
    { brand: "NPS सहाय्यक" },
    ...
    {},
    {},
    { title: "AI पेन्शन प्लॅनर", subtitle: "AI वांगडा तुमचो निवृत्ती प्लॅन तयार करात" }
);
const doiT = makeLang(
    { brand: "NPS सहायक" },
    ...
    {},
    {},
    { title: "AI पेंशन प्लानर", subtitle: "AI दे कन्नै अपना रिटायरमेंट प्लान बनाओ" }
);
const mniT = makeLang(
    { brand: "NPS পাউবী" },
    ...
    {},
    {},
    { title: "AI পেন্সন প্লান্নার", subtitle: "AI ওকগা লোইননা নখোয়গী পেন্সন প্লান শাগৎলু" }
);
const brxT = makeLang(
    { brand: "NPS गोहोयाव" },
    ...
    {},
    {},
    { title: "AI पेन्सन प्लानर", subtitle: "AI जों नोंथांनि पेन्सन प्लान बानाइ" }
);

export const translations: Record<Language, TranslationSet> = {
    en, hi, ta, te, bn, mr, gu, kn, ml, pa,
    or: or, as: as, ur: ur, sa: sa, mai: mai,
    sat: satT, ks: ksT, ne: neT, sd: sdT, kok: kokT,
    doi: doiT, mni: mniT, brx: brxT,
};
