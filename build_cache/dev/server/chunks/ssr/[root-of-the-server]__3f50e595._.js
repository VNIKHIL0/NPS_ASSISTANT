...
const translations = {
    en: {
        ...
        hero: {
            ...
            f1desc: "Ask questions in English, Hindi, or your native language. Our AI understands and responds instantly.",
            f2title: "Pension Calculator",
            f2desc: "Visualize your future wealth. See how small contributions today can lead to a secure tomorrow.",
            f3title: "Financial Literacy",
            f3desc: "Master the National Pension System with easy-to-understand guides and tutorials."
        }
    },
    hi: {
        nav: {
        ...
        hero: {
            ...
            featuresSubtitle: "आपकी सेवानिवृत्ति योजना को प्रबंधित करने के लिए व्यापक उपकरण।",
            f1title: "बहुभाषी एआई चैट",
            f1desc: "अंग्रेजी, हिंदी या अपनी मातृभाषा में प्रश्न पूछें। हमारा एआई तुरंत समझता है और जवाब देता है।",
            f2title: "पेंशन कैलकुलेटर",
            f2desc: "अपने भविष्य की संपत्ति की कल्पना करें। देखें कि आज का छोटा योगदान कल को कैसे सुरक्षित बना सकता है।",
            f3title: "वित्तीय साक्षरता",
            f3desc: "समझने में आसान गाइड और ट्यूटोरियल के साथ राष्ट्रीय पेंशन प्रणाली में महारत हासिल करें।"
        }
    }
};
}),
...
;
;
// Default context value matching the type structure
...
function LanguageProvider({ children }) {
    ...
    // Load saved preference only on client side mount
    ...
    const t = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$translations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["translations"][language];
...
;
function Navbar() {
    const { t, language, setLanguage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$LanguageContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLanguage"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f50e595._.js.map